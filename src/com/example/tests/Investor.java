...
public class Investor {
  ...
  public void testLogincustomer() throws Exception {
    ...
    ((JavascriptExecutor) driver).executeScript("window.scrollTo(0, 0);");
    Thread.sleep(3000);
    driver.findElement(By.xpath("//*[@id=\"root\"]/div[3]/div[2]/div/div[1]/div[2]/div[2]/div/input")).sendKeys("NEW INVESTOR Compan");
    Thread.sleep(3000);
    driver.findElement(By.xpath("//*[@id=\"root\"]/div[3]/div[2]/div/div[1]/div[2]/div[2]/div/input")).clear();
    Thread.sleep(3000);
    driver.findElement(By.xpath("//*[text() = \"RoadShow\"]")).click();
    Thread.sleep(3000);
    driver.findElement(By.xpath("//input[@placeholder = \"Search by email, company name\"]")).sendKeys("A W Jones Advisors LLC");
    Thread.sleep(3000);
    driver.findElement(By.xpath("//*[text() = \"A W Jones Advisors LLC\"]")).click();
    Thread.sleep(3000);
